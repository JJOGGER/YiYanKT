 ...
 * 描述：
 */
class YiYanFooter : InternalAbstract, RefreshHeader {
...
//    }
    ...
    fun setLoadingAniDuration(duration: Int): YiYanFooter {
        mLoadingAniDuration = duration
        mLoadingAniSegDuration = duration
        return this
    }

    fun setLineWidth(width: Int): YiYanFooter {
        mLineWidth = width
    ...
    fun setTextColor(@ColorInt color: Int): YiYanFooter {
        mTextColor = color
        for (i in mItemList.indices) {
    ...
    fun setDropHeight(height: Int): YiYanFooter {
        mDropHeight = height
        return this
    }

    fun initWithString(str: String?): YiYanFooter {
        initWithString(str, 25)
        return this
    }

    fun initWithString(str: String?, fontSize: Int): YiYanFooter {
        val pointList = YiYanHeaderPath.getPath(str, fontSize * 0.01f, 14)
        initWithPointList(pointList)
        return this
    }

    fun initWithStringArray(id: Int): YiYanFooter {
        val thisView = this
    ...
    fun setScale(scale: Float): YiYanFooter {
        mScale = scale
        return this
    }

    fun initWithPointList(pointList: List<FloatArray>): YiYanFooter {
