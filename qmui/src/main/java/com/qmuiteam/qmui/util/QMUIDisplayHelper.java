...
import com.qmuiteam.qmui.QMUIContext;
...
//    private static int[] sLandscapeRealSizeCache = null;
    ...
    public static int getScreenWidth() {
        return getDisplayMetrics(QMUIContext.getContext()).widthPixels;
    }
    /**
     * 获取屏幕高度
     *
    ...
    public static int getScreenHeight() {
        int screenHeight = getDisplayMetrics(QMUIContext.getContext()).heightPixels;
        if (QMUIDeviceHelper.isXiaomi() && xiaomiNavigationGestureEnabled(QMUIContext.getContext())) {
            screenHeight += getResourceNavHeight(QMUIContext.getContext());
        }
        return screenHeight;
    }
    /**
...
//        }
    ...
    public static int dp2px(int dp) {
        return (int) (getDensity(QMUIContext.getContext()) * dp + 0.5);
    }

    public static int sp2px(int sp) {
        return (int) (getFontDensity(QMUIContext.getContext()) * sp + 0.5);
    }
    ...
    public static int px2dp( int px) {
        return (int) (px / getDensity(QMUIContext.getContext()) + 0.5);
    }
    /**
     * 单位转换:px -> sp
     *
